...
export const styles = {
  ...
  // Small secondary-action look -- re-opens the Plaid Link flow to
  // connect a bank at any time, not just first login,
  ...
  addBankConfirmActions: {
    display: "flex",
    gap: 8,
  },
  addBankConfirmCancel: {
    background: "none",
    border: "1px solid var(--border)",
    borderRadius: 7,
    padding: "6px 14px",
  ...
  // Ambient container the floating query suggestions animate through --
  // see AskPage.jsx. Needs a real height for the percentage-based
  // bottom/opacity keyframes to animate relative to.
  suggestionsWrap: {
    position: "relative",
    height: "55vh",
    minHeight: 320,
  ...
  ruleDeleteConfirmText: {
    flex: 1,
    color: "var(--text)",
    fontSize: 13,
    fontFamily: "var(--font-body)",
  },
  ruleDeleteConfirmDelete: {
